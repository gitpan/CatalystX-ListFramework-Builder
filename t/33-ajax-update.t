...
$mech->ajax_ok('/album/update', {}, {success => 'false'}, 'add row, no data');
$mech->ajax_ok('/album/list', {'search.title' => 'Greatest Hits'}, $default_album_page, 'check data');

$mech->ajax_ok('/album/update', {
    id => 5,
...
$mech->ajax_ok('/album/list', {'search.title' => 'Testing Hits'}, $testing_album_page, 'check data');
...
$mech->ajax_ok('/album/list', {'search.title' => 'Greatest Hits 2'}, $default_album_page, 'check data');
...
$mech->ajax_ok('/album/list', {'search.title' => 'Greatest Hits 2'}, $default_album_page, 'check data');
$mech->ajax_ok('/artist/list', {'search.surname' => 'Thornton'}, $new_artist_page, 'check data');
...
$mech->ajax_ok('/album/list', {'search.title' => 'Greatest Hits 2'}, $default_album_page, 'check data');
$mech->ajax_ok('/sleeve_notes/list', {'search.text' => 'Very cool album indeed'}, $new_sleeve_page, 'check data');
...
$mech->ajax_ok('/artist/list', {'search.forename' => 'Charlie'}, {total => 0, rows => []}, 'check data');
...
$mech->ajax_ok('/album/list', {'search.title' => 'Testing Hits 2'}, {total => 0, rows => []}, 'check data');
$mech->ajax_ok('/artist/list', {'search.surname' => 'Thornton'}, $new_artist_page, 'check data');
...
$mech->ajax_ok('/album/list', {'search.title' => 'Testing Hits 2'}, $new_album_page, 'check data');
$mech->ajax_ok('/artist/list', {'search.forename' => 'Charlie'}, $second_artist_page, 'check data');

$mech->ajax_ok('/track/update', {
    title => 'Track Title',
    'combobox.album_id' => '',
    'checkbox.album' => 'on',
...
$mech->ajax_ok('/track/list', {'search.title' => 'Track Title'}, {total => 0, rows => []}, 'check data');
$mech->ajax_ok('/copyright/list', {'search.rights_owner' => 'Label D'}, {total => 0, rows => []}, 'check data');
$mech->ajax_ok('/album/list', {'search.recorded' => '1999-05-21'}, {total => 0, rows => []}, 'check data');
...
$mech->ajax_ok('/track/list', {'search.title' => 'Track Title'}, {
    'total' => 1,
    'rows' => [
                {
                  'length' => '',
